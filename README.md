...
```
The output is the image recovered in GeoTIFF format. For the considered example the output image is available [here](https://www.dropbox.com/s/hu5wca8bkh23jo7/20180402163741_APS_MM_ZENITH_MERGED_recovered.tif?dl=0).
